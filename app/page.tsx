    ...
    <div>
      <section className="section">
        <div className="container grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h1 className="h1">Digital Marketing that <span className="text-primary">scales</span>. Websites that <span className="text-accent">perform</span>.</h1>
            <p className="p mt-5">We blend SEO, ads, and social with conversion‑first Next.js builds. Less fluff, more results.</p>
