    ...
    <section className="section">
      <div className="container grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="p mt-3">We’re a performance‑driven team blending marketing strategy with modern web engineering. We deliver measurable growth and delightful user experiences.</p>
