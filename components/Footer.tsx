...
<div>
  ...
  <div className="flex gap-4 text-gray-600">
    ...
    <Link
      ...
      target="_blank"
      className="transition transform hover:scale-110 hover:text-[#1DA1F2]"
    >
    ...
    <Link
      ...
      target="_blank"
      className="transition transform hover:scale-110 hover:text-[#E4405F]"
    >
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    <Link
      ...
      target="_blank"
      className="transition transform hover:scale-110 hover:text-[#FF0000]"
    >
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
